...
function getExtraInfo(item: ItemDefinition, game: GameContextType) {
	if (item.equipmentSlot === EquipmentSlot.Belt) {
		// TODO: Actually get unlocked skills.
		/*const unlockedSkills = [ Skill.Mining, Skill.Woodcutting, Skill.Fishing,
			Skill.Cooking, Skill.Agility, Skill.Brewing, Skill.Carpentry, Skill.Crafting ];*/
