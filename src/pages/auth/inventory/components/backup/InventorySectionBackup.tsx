...
import React, { memo, TouchEvent, useContext, useEffect, useRef, useState } from "react";
...
export const InventorySectionBackup: React.FC<InventorySectionProps> = memo(InventorySectionComponent, MemoEqual);
