...
import { InventoryCurrentlyDraggingContext } from "@pages/auth/inventory/InventoryPage.tsx";
...
import { toKMB } from "@idleclient/game/utils/numberUtils";
...
function InventorySectionComponent({
	...
	const draw = (
		...
		const sheet = icon && sheets.get(icon.sheet.image);
