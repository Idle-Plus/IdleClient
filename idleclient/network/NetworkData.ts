...
export interface CombatOfflineProgressNetwork {
	CombatEnded: boolean;
	ConsumedFood: Map<Int /* i32 */, Int /* i32 */> | null;
	ExperiencesReceived: Map<Byte /* i8 */, Int /* i32 */> | null;
	ExterminatingPointsReceived: Int /* i32 */;
	LevelsReceived: Map<Byte /* i8 */, Int /* i32 */> | null;
	MonsterKillsByTaskId: Map<Int /* i32 */, Int /* i32 */> | null;
	PlayerDied: boolean;
	ReceivedLoot: Map<Int /* i32 */, Int /* i32 */> | null;
	TaskId: Byte /* i8 */;
...
export interface PetOfflineProgression {
	...
	ItemsLost: Map<Int /* i32 */, Int /* i32 */>;
	ItemsReceived: Map<Int /* i32 */, Int /* i32 */>;
	NewLevel: Byte /* i8 */;
	OldLevel: Byte /* i8 */;
	Skill: Skill;
	TaskId: Int /* i32 */;
